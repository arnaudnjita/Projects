...
| FR-09 | Farmer profile create/edit | `FarmerProfilePage`, `FarmerProfileForm` | `GET /api/farmers/me/profile`, `PUT /api/farmers/me/profile`, `POST /api/farmers/me/profile/photo` | `farmer_profiles`, `users` | Farmer-only profile read/update, buyer 403, photo upload tests | Backend implemented; frontend profile page remains separate from product form milestone |
